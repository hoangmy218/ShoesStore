                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="position-center">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{$edit_value->ms_ten}}" name="color_name" class="form-control" id="exampleInputName1" required="" placeholder="Name" >
                                            </div>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    <h5 class="modal-title" id="demoModalLabel">Hủy chỉnh sửa màu sắc sản phẩm</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                </div>
                                <div class="modal-body">
                                Bạn có chắc chắn muốn hủy chỉnh sửa màu sắc này?
                                </div>
